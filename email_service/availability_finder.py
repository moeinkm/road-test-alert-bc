...
class AvailabilityFinder:
    ...
    def __init__(self):
        ...
        self.login_data = {
            'drvrLastName': Config.get_env_variable('USER_LAST_NAME'),
            'licenceNumber': Config.get_env_variable('USER_LICENSE_NUMBER'),
            'keyword': Config.get_env_variable('USER_KEYWORD')
        }
